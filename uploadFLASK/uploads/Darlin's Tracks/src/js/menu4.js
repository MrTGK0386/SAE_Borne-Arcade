...
export default class menu4 extends Phaser.Scene {
  constructor() {
    super({ key: "menu4" });
  }
  ...
  create() {
    const menu4 = this.sound.add("menu4");
    menu4.setVolume(0.3);
    menu4.play();
    // on place les éléments de fond
    const menuFond = this.add.image(0, 0, "menuNiv4").setOrigin(0).setDepth(0);
    ...
    var hitbox = this.add.rectangle(820, 535, 340, 140);
